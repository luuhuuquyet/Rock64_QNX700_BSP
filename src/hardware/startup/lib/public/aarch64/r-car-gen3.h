 ...
 * Gen3 shared definitions: H3, M3, V3M
 */

#ifndef __AARCH64_RCAR_GEN3_H_INCLUDED
#define __AARCH64_RCAR_GEN3_H_INCLUDED

#define RCAR_GEN3_EXT_CLK                48000000        /* External crystal clock */
...
#define RCAR_GEN3_CPG_SIZE               0x1000
 ...
 #define RCAR_GEN3_CPG_RPCCKCR           0x238
...
#define RCAR_GEN3_SYSC_BASE              0xE6180000
 ...
 #define RCAR_GEN3_SYSC_EXTMASK_V3M      0x1B0        // V3m only: Power control protection error register
...
#define RCAR_GEN3_SYSDMAC_SIZE           0x3000      // BASE+REGS to DESC
 ...
 #define RCAR_GEN3_SYSDMAC_DMASAR        0x00
 #define RCAR_GEN3_SYSDMAC_DMADAR        0x04
 #define RCAR_GEN3_SYSDMAC_DMATCR        0x08
 #define RCAR_GEN3_SYSDMAC_DMACHCR       0x0C
 #define RCAR_GEN3_SYSDMAC_DMAFIXSAR     0x10
 #define RCAR_GEN3_SYSDMAC_DMAFIXDAR     0x14
 #define RCAR_GEN3_SYSDMAC_DMATCRB       0x18
 #define RCAR_GEN3_SYSDMAC_DMACHCRB      0x1C
 #define RCAR_GEN3_SYSDMAC_DMASART       0x20
 #define RCAR_GEN3_SYSDMAC_DMADART       0x24
 #define RCAR_GEN3_SYSDMAC_DMATSR        0x28
 #define RCAR_GEN3_SYSDMAC_DMACHCRT      0x2C
 #define RCAR_GEN3_SYSDMAC_DMATSRB       0x38
 #define RCAR_GEN3_SYSDMAC_DMARS         0x40
 #define RCAR_GEN3_SYSDMAC_DMABUFCR      0x48
 #define RCAR_GEN3_SYSDMAC_DMADPBASE     0x50
 #define RCAR_GEN3_SYSDMAC_DMADPCR       0x54
 #define RCAR_GEN3_SYSDMAC_DMAFIXDPBASE  0x60
...
#define RCAR_GEN3_RPC_DIV_REG        0xA8    /* Divider clock register */
...
#define RCAR_GEN3_PRODUCT_ID(x)          ((x & 0x7F00) >> 8)
 ...
 #define PRODUCT_ID_RCAR_V3              0x54
...
#define RCAR_GEN3_PRODUCT_REV(x)         (x & 0xFF)
 #define PRODUCT_GEN3_REV_1_0            0x00
 #define PRODUCT_GEN3_REV_1_1            0x01
 #define PRODUCT_GEN3_REV_2_0            0x10
 #define PRODUCT_GEN3_REV_3_0            0x20
...
#define RCAR_GEN3_INTCSYS_SYSDMAC1_8     (312 + 32)  // SYSDMAC2_0 for V3M & V3H
#define RCAR_GEN3_INTCSYS_SYSDMAC1_9     (313 + 32)  // SYSDMAC2_1 for V3M & V3H
#define RCAR_GEN3_INTCSYS_SYSDMAC1_10    (314 + 32)  // SYSDMAC2_2 for V3M & V3H
#define RCAR_GEN3_INTCSYS_SYSDMAC1_11    (315 + 32)  // SYSDMAC2_3 for V3M & V3H
#define RCAR_GEN3_INTCSYS_SYSDMAC1_12    (316 + 32)  // SYSDMAC2_4 for V3M & V3H
#define RCAR_GEN3_INTCSYS_SYSDMAC1_13    (317 + 32)  // SYSDMAC2_5 for V3M & V3H
#define RCAR_GEN3_INTCSYS_SYSDMAC1_14    (318 + 32)  // SYSDMAC2_6 for V3M & V3H
#define RCAR_GEN3_INTCSYS_SYSDMAC1_15    (319 + 32)  // SYSDMAC2_7 for V3M & V3H
...
#define RCAR_GEN3_INTCSYS_SCU1           (353 + 32)  // SYSDMAC1_8 for V3H
#define RCAR_GEN3_INTCSYS_SCU2           (354 + 32)  // SYSDMAC1_9 for V3H
#define RCAR_GEN3_INTCSYS_SCU3           (355 + 32)  // SYSDMAC1_10 for V3H 
#define RCAR_GEN3_INTCSYS_SCU4           (356 + 32)  // SYSDMAC1_11 for V3H 
#define RCAR_GEN3_INTCSYS_SCU5           (357 + 32)  // SYSDMAC1_12 for V3H 
#define RCAR_GEN3_INTCSYS_SCU6           (358 + 32)  // SYSDMAC1_13 for V3H 
#define RCAR_GEN3_INTCSYS_SCU7           (359 + 32)  // SYSDMAC1_14 for V3H 
#define RCAR_GEN3_INTCSYS_SCU8           (360 + 32)  // SYSDMAC1_15 for V3H  
#define RCAR_GEN3_INTCSYS_SCU9           (361 + 32)  // SYSDMAC2_8 for V3H   
#define RCAR_GEN3_INTCSYS_MLM0           (362 + 32)  // SYSDMAC2_9 for V3H   
#define RCAR_GEN3_INTCSYS_MLM1           (363 + 32)  // SYSDMAC2_10 for V3H 
#define RCAR_GEN3_INTCSYS_MLM2           (364 + 32)  // SYSDMAC2_11 for V3H 
#define RCAR_GEN3_INTCSYS_MLM3           (365 + 32)  // SYSDMAC2_12 for V3H 
#define RCAR_GEN3_INTCSYS_MLM4           (366 + 32)  // SYSDMAC2_13 for V3H 
#define RCAR_GEN3_INTCSYS_MLM5           (367 + 32)  // SYSDMAC2_14 for V3H 
#define RCAR_GEN3_INTCSYS_MLM6           (368 + 32)  // SYSDMAC2_15 for V3H 
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/mainline/hardware/startup/lib/public/aarch64/r-car-gen3.h $ $Rev: 841928 $")
#endif
